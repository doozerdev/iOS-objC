...
- (void)checkButtonTapped:(id)sender
{
    ...
    if (indexPath != nil)
    {
        ...
        NSLog(@"item name = %@", itemToToggleComplete.title);
        
        itemToToggleComplete.done = [NSNumber numberWithBool:true];
        NSLog(@"here's the item after being toggled = %@", itemToToggleComplete.title);
        ...
        NSLog(@"the value of complete item = %@", itemToToggleComplete.done);
